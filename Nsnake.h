...
private:
	...
	bool checkTime;
	char direction, headchar, partchar, edgechar, growthchar, poisonchar, gatechar;
	...
	// growthchar is the character representing the growth
	// del stands for delay
	bool bEatsGrowth,bEatsPoison, gateTo, gatestate, changestage;
	CharPosition growth, poison, gate1, gate2; // need to clarify this combination
